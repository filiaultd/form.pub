### look at allele frequencies between two species pools
### prep work is done in scripst 10 and 11 in this directory
### DLF 13April18
### Update 24 April 18 - this script mostly just does site frequency spectra (was originally meant to calculate divergence, but this has migrated to 16/17)
